...
static const a_alias_t APP_ALIAS[] = {
    ...
    { "games",              { "giochi", "gioco", "games", "game", "giocare", "partita", "multiplayer", NULL } },
    { "arcade",             { "arcade", "emulator", "emulazione", "emulation", "rom", "roms", "retrogaming", "nes", "snes", "game boy", "gameboy", "mega drive", "megadrive", "emula", NULL } },
